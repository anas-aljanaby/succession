...
const OrganizationForm: React.FC<OrganizationFormProps> = ({ organization, t, onSave, onCancel }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const orgDataToSave: Omit<Organization, 'id'> = {
      ...organization!, // Keep existing data not in form
      name: formData.name,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in-up">
      ...
      <h2 className="text-3xl font-bold text-white">
        {organization ? `تعديل: ${organization.name}` : 'إضافة مؤسسة جديدة'}
      </h2>
        ...
        <Card>
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-300 mb-1">اسم المؤسسة</label>
            ...
            <div>
              <label htmlFor="logo" className="block text-sm font-medium text-gray-300 mb-1">رابط الشعار</label>
            ...
            <fieldset className="border-t border-gray-700 pt-6">
              <legend className="text-lg font-semibold text-white mb-4">معلومات الاتصال</legend>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                ...
                <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-gray-300 mb-1">الهاتف</label>
